...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_ccf_sin_retencion.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_ccf_sin_retencion extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->description = "Comprobante de crédito fiscal sin retención de IVA";
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->SetFont('','',$default_font_size);
		$pdf->SetXY(70,35); // ---------------------------------------------------------- FACTURE EXPEDITION DATE
		$pdf->SetTextColor(0,0,0);
