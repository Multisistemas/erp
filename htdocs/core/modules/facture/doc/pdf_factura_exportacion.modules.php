...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_factura_exportacion.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_factura_exportacion extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "factura_exportacion";
		$this->description = "Factura de exportación";
