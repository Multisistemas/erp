...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_facmultisis.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_facmultisis extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "facmultisis";
		$this->description = "FAC - Multisis Template";
