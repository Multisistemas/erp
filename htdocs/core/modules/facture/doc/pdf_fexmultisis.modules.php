...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_fexmultisis.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_fexmultisis extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "fexmultisis";
		$this->description = "FEX - Multisis Template";
