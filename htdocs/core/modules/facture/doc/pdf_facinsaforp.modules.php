...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_facinsaforp.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_facinsaforp extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
        ...
        ////////////////////////////////////////////////////////////
            ...
            $pdf->SetXY($this->posxdiscount-2, $curY);
				...
				$pdf->SetXY($this->postotalht, 233); // ----------------------------------- TOTAL WITHOUT IVA
				...
				foreach($this->tva as $tvakey => $tvaval)
				{
					if ($tvakey != 0)    // On affiche pas taux 0
					{
						...
						$index++;
						$pdf->SetXY($this->postotalht - 10, 238);
						...
						//$totalvat = ()
						$pdf->MultiCell(25, 4, "1%", 0, 'L', 1); // --------------------------------- IVA 1%
					}
				}
				...
				$pdf->SetXY($this->postotalht, 238); // --------------------------------------------- IVA AMOUNT
				$pdf->MultiCell(25, 4, "$ ".price($theiva,0,$outputlangs,1,2,2), $useborder, 'R', 1);

				// Total TTC
				$index++;
				$pdf->SetXY($this->postotalht, 260); // --------------------------------------------- TOTAL AMOUNT
				$pdf->MultiCell(25, 4, "$ ".price($total_ht - $theiva, 0, $outputlangs,1,2,2), $useborder, 'R', 1);
