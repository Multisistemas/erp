...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_factura_consumidor_final.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_factura_consumidor_final extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "factura_consumidor_final";
		$this->description = "Factura consumidor final (sin descripción de IVA)";
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->facture->dir_output) {
			...
			if (file_exists($dir)) {
				...
				// Sumas
				$pdf->SetXY($this->postotalht + 3, 231);
