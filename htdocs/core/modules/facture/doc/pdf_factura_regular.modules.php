...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_factura_regular.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_factura_regular extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "factura_regular";
		$this->description = "Factura regular";
